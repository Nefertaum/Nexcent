...
export function Achievemennts() {
  return (
    <div className="flex inline-flex justify-between items-center w-[1440] h-[288] pt-[64px] pr-[144px] pb-[64px] pl-[144px] bg-[#F5F7FA] ">
      <div className=" flex flex-col w-[540] h-[120] gap-[8px] ">
        <SectionHeading />
        <Description />
      </div>
      <div className="flex flex-col justify-between  w-[540] h-[160] gap-[40px] ">
