...
export function Frame4() {
  return (
    <div className="flex inline-flex justify-between content-between w-[1440] h-[280] pr-[144px] pl-[144px] ">
      <div className="flex flex-col justify-between items-center content-between w-[299] h-[260] rounded-lg pt-[24px] pr-[32px] pb-[24px] pl-[32px] gap-[8px] shadow-[0_2px_4px_#ABBED133]">
        <div className="w-[267] h-[144] gap-[16px] ">
          <Image
      ...
      <div className="flex-col justify-between items-center content-between w-[299] h-[260] rounded-lg pt-[24px] pr-[32px] pb-[24px] pl-[32px] gap-[8px] shadow-[0_2px_4px_#ABBED133]">
        <div className="w-[267] h-[144] gap-[16px] ">
          <Image
